 ...
 */
public abstract class AbstracDocx4j {

    private Logger logger = LoggerFactory.getLogger(AbstracDocx4j.class);
    ...
    protected OutputStream getOutputDocument(WordprocessingMLPackage document) throws Docx4JException, IOException {
        OutputStream out = getOutputStream();
        document.save(out); 
        return out;
    }
