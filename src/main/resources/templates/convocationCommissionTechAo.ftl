...
<meta charset="UTF-8" />
<title>Convocation commission technique</title>
<style>
...
<body>
	<div class="marge_page font-reportAR">
		...
		<p class="titreAR"
			...
			<b style="text-decoration: underline;">الموضــــــوع :</b>اجتماع اللجنة التقنية
		</p>
		<br />
		...
		<p class="font-reportAR">يشرفني أن اطلب منكم التفضل لحضور أشغال اللجنة التقنية أو ايفاد من يمثلكم يوم  <b>${detail.dateOuverturePlis?string["yyyy/MM/dd"]}</b> على
			الساعة <b>${detail.dateOuverturePlis?string["HH:mm"]}</b>، بقاعة الاجتماعات لجماعة مراكش بشارع محمد السادس وذلك لدراسة العروض التقنية <#if _echantillion??> او العينات (<b>${_echantillion.libelle}</b>)</#if> المقدمة من طرف المتنافسين في  طلب العروض رقم  <b>&nbsp;${detail.numAo}</b>
			والمتعلق ب :</p>
		<ul>
