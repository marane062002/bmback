...
<body>
	<div class="template_top_header" >
		...
		<table class="table" width="100%">
			...
			<tbody>
				<tr>
					<td class="boder-table td-secteur" style="text-align:left;vertical-align:top;padding:0;padding-top:10px"><span class="txt-weight">Dossier de consultation Architecturale : </span>
					<ul class="list-group">
                            <li style=" display: flex;"> Contrat architecturale</li>
							...
							<li style=" display: flex;"> Programme</li>
							<li style=" display: flex;">${detail.type}</li>
							<li style=" display: flex;"> Modèle déclaration sur l’honneur et acte d’engagement  relatif au <strong> Consultation Architecturale : n° </strong><b>${detail.numCA}</b> . pour :</li>
                        </ul>
						<br /><br />
						<p>&nbsp; - <b>${detail.objetFR}</b>. </p>
						<br /><br />
					</td>
			...
			<tr>
				...
				<td width="30%">
					<dir style="font-size: 16px; padding-top: 10%;">
						<p>LE PRESIDENT DE LA COMMUNE DE MARRAKECH</p>
						<p>A</p>
						<p>MONSIEUR LE DIRECTEUR GENERAL DES SERVICES</p>
					</dir>
				</td>
			</tr>
		</table>
			...
			<tbody>
				<tr>
					...
					<ul class="list-group">
							...
							<li style=" display: flex;"> Programme</li>
							<li style=" display: flex;">${detail.type}</li>
							<li style=" display: flex;"> Modèle déclaration sur l’honneur et acte d’engagement  relatif au <strong> Consultation Architecturale</strong> : n°<b>${detail.numCA}</b> . pour :</li>
                        </ul>
						<br /><br />
						<p>&nbsp; - <b>${detail.objetFR}</b>. </p>
						<br /><br />
			...
			<tr>
				...
				<td width="30%">
					<dir style="font-size: 16px; padding-top: 10%;">
						<p>LE PRESIDENT DE LA COMMUNE DE MARRAKECH</p>
						<p>A</p>
						<p>MONSIEUR LE CHEF DE LA DIVISION D'URBANISME DE LA COMMUNE</p>
					</dir>
				</td>
			</tr>
		</table>
			...
			<tr>
				...
				<td width="30%">
					<dir style="font-size: 16px; padding-top: 10%;">
						<p>LE PRESIDENT DE LA COMMUNE DE MARRAKECH</p>
						<p>A</p>
						<p>MONSIEUR L'INSPECTEUR REGIONAL</p>
						<p>DE L'URBANISME DE LA REGION MARRAKECH SAFI</p>
